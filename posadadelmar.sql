...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-05-2025 a las 17:49:52
...
(1, 'Cebollas', '', 'kg', 12.500, 1.000, 1, 0.00, '', '2025-05-12 07:55:01'),
(2, 'Tomate', '', 'kg', 6.000, 1.000, 1, 0.00, '', '2025-05-12 07:56:14'),
(3, 'Tajali', '', 'kg', 20.000, 1.000, 1, 0.00, '', '2025-05-12 07:56:28'),
(4, 'limón', '', 'kg', 3.400, 1.000, 1, 0.00, '', '2025-05-12 07:56:41'),
(5, 'Harina pan', '', 'kg', 33.500, 1.000, 1, 0.00, '', '2025-05-12 07:56:59'),
(6, 'aceite', '', 'l', 47.967, 1.000, 1, 0.00, '', '2025-05-12 07:57:19'),
(7, 'harina de trigo todo uso', '', 'kg', 10.000, 1.000, 1, 0.00, '', '2025-05-12 07:58:11'),
(8, 'huevos', '', 'unidad', 80.000, 1.000, 1, 0.00, '', '2025-05-12 07:58:28'),
(9, 'sal', '', 'kg', 10.000, 1.000, 1, 0.00, '', '2025-05-12 07:59:03'),
(10, 'cilantro', '', 'kg', 5.000, 1.000, 1, 0.00, '', '2025-05-12 07:59:29'),
(11, 'pimentón', '', 'kg', 10.000, 1.000, 1, 0.00, '', '2025-05-12 07:59:56'),
(12, 'Pargo Rojo', '', 'kg', 23.000, 1.000, 1, 0.00, '', '2025-05-12 08:23:35'),
(13, 'Refrescos', 'Cool 2 ltros', 'unidad', 50.000, 1.000, 1, 0.00, '', '2025-05-27 10:19:14');
...
(2, 'sin', 'Refrescos', 'cool 2 litros', 2, 1.50, 1, 1, NULL),
(3, '121', 'Tomate', 'a', 1, 0.30, 1, 1, NULL);
...
--
ALTER TABLE `ingredientes`
  MODIFY `IngredienteID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `recetas`
  MODIFY `RecetaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `ventas`
  MODIFY `VentaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `ventaservicios`
  MODIFY `VentaServicioID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
