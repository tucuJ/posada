...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2025 a las 03:06:48
...
CREATE TABLE `consumoingredientes` (
  ...
  `CantidadConsumida` varchar(200) NOT NULL,
...
(6, 18, 4, '0.4', '2025-05-12 18:56:11', 1),
(7, 18, 12, '2', '2025-05-12 18:56:11', 1),
(8, 18, 1, '1', '2025-05-12 18:56:11', 1),
(9, 18, 5, '1', '2025-05-12 18:56:11', 1),
(10, 18, 6, '0.002', '2025-05-12 18:56:11', 1),
(16, 20, 4, '0.4', '2025-05-12 18:58:53', 1),
(17, 20, 12, '2', '2025-05-12 18:58:53', 1),
(18, 20, 1, '1', '2025-05-12 18:58:53', 1),
(19, 20, 5, '1', '2025-05-12 18:58:53', 1),
(20, 20, 6, '0.002', '2025-05-12 18:58:53', 1),
(51, 27, 4, '0.6', '2025-05-12 19:44:53', 1),
(52, 27, 12, '3', '2025-05-12 19:44:53', 1),
(53, 27, 1, '1.5', '2025-05-12 19:44:53', 1),
(54, 27, 5, '1.5', '2025-05-12 19:44:53', 1),
(55, 27, 6, '0.003', '2025-05-12 19:44:53', 1),
(56, 28, 4, '0.6', '2025-05-12 19:50:53', 1),
(57, 28, 12, '3', '2025-05-12 19:50:53', 1),
(58, 28, 1, '1.5', '2025-05-12 19:50:53', 1),
(59, 28, 5, '1.5', '2025-05-12 19:50:53', 1),
(60, 28, 6, '0.003', '2025-05-12 19:50:53', 1),
(61, 29, 4, '0.6', '2025-05-12 19:56:51', 1),
(62, 29, 12, '3', '2025-05-12 19:56:51', 1),
(63, 29, 1, '1.5', '2025-05-12 19:56:51', 1),
(64, 29, 5, '1.5', '2025-05-12 19:56:51', 1),
...
(81, 33, 1, '0.2', '2025-05-27 17:49:28', 1),
(82, 33, 6, '0.5', '2025-05-27 17:49:28', 1);
...
INSERT INTO `habitaciones` (`HabitacionID`, `Numero`, `TipoHabitacionID`, `Estado`, `Notas`, `costom`) VALUES
(1, '1', 1, 'Disponible', 'a', '4'),
(2, '2', 1, 'Disponible', '', '4'),
(3, '3', 1, 'Disponible', 'a', '4'),
(4, '4', 2, 'Disponible', '', '4'),
(5, '5', 1, 'Disponible', 'a', '5'),
(6, '6', 1, 'Disponible', 'a', '5'),
(7, '7', 1, 'Disponible', 'a', '5'),
(8, '8', 1, 'Disponible', 'a', '4');
...
CREATE TABLE `ingredientes` (
  ...
  `StockMinimo` varchar(200) DEFAULT NULL,
  `Activo` tinyint(1) DEFAULT 1,
...
INSERT INTO `ingredientes` (`IngredienteID`, `Nombre`, `Descripcion`, `UnidadMedida`, `Stock`, `StockMinimo`, `Activo`, `precio`, `cantidad`, `FechaCreacion`) VALUES
(1, 'Cebollas', '', 'kg', '12.3', '1', 1, 1.20, '1', '2025-05-12 07:55:01'),
(2, 'Tomate', '', 'kg', '56', '1.000', 1, 1.00, '1.000', '2025-05-12 07:56:14'),
(3, 'Tajali', '', 'kg', '20.000', '1.000', 1, 2.00, '1.000', '2025-05-12 07:56:28'),
(4, 'limón', '', 'kg', '3.4', '1', 1, 1.00, '0.000', '2025-05-12 07:56:41'),
(5, 'Harina pan', '', 'kg', '33.500', '1.000', 1, 1.00, '1.000', '2025-05-12 07:56:59'),
(6, 'aceite', '', 'l', '46.5', '1', 1, 1.50, '1', '2025-05-12 07:57:19'),
(7, 'harina de trigo todo uso', '', 'kg', '10.000', '1.000', 1, 0.00, '0.000', '2025-05-12 07:58:11'),
(8, 'huevos', '', 'unidad', '80.000', '1.000', 1, 0.00, '0.000', '2025-05-12 07:58:28'),
(9, 'sal', '', 'kg', '10.000', '1.000', 1, 0.00, '0.000', '2025-05-12 07:59:03'),
(10, 'cilantro', '', 'kg', '5.000', '1.000', 1, 0.00, '0.000', '2025-05-12 07:59:29'),
(11, 'pimentón', '', 'kg', '10.000', '1.000', 1, 0.00, '0.000', '2025-05-12 07:59:56'),
(12, 'Pargo Rojo', '', 'kg', '23', '1', 1, 2.50, '1', '2025-05-12 08:23:35'),
(13, 'Refrescos', 'Cool 2 ltros', 'unidad', '50.000', '1.000', 1, 0.00, '0.000', '2025-05-27 10:19:14'),
(14, 'arroz', 'Arroz comun', 'kg', '1.000', '1.000', 1, 0.00, '0.000', '2025-05-27 11:20:17'),
(15, 'cacao', 'cacao en polvo', 'g', '500', '1', 1, 1.15, '500', '2025-05-27 11:22:00');
...
(97, 2, 'Entrada', '50', 'fghgfhfghfgh', 'entrada', 1, '2025-05-27 17:33:45'),
(98, 1, 'Salida', '0.2', 'Orden #33', 'Preparación de platillo', 1, '2025-05-27 17:49:28'),
(99, 6, 'Salida', '0.5', 'Orden #33', 'Preparación de platillo', 1, '2025-05-27 17:49:28');
...
INSERT INTO `inventariomovimientos` (`MovimientoID`, `ProductoID`, `Tipo`, `Cantidad`, `PrecioUnitario`, `FechaHora`, `UsuarioID`, `Referencia`, `Notas`) VALUES
(27, 8, 'Salida', 1, 24.00, '2025-05-27 10:48:26', 1, 'Venta #52', NULL);
...
(33, 33, 1, 1, 10.00, NULL, 'Entregado'),
(34, 33, 3, 4, 0.30, NULL, 'Entregado');
...
(33, 1, NULL, NULL, 1, '2025-05-27 17:49:28', 'Entregado', 'ParaLlevar', 11.20, 0.00, 1.34, 12.54, '');
...
(6, 'Jesus Alfredo', 'pgo', 1.50, 3, 1, '2025-05-27 18:39:36');
...
CREATE TABLE `platillos` (
  ...
  `CostoFabricacion` decimal(10,2) DEFAULT 0.00
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `platillos` (`PlatilloID`, `Codigo`, `Nombre`, `Descripcion`, `CategoriaPlatilloID`, `PrecioVenta`, `TiempoPreparacion`, `Activo`, `Imagen`, `CostoFabricacion`) VALUES
(1, '21312321312312', 'Pescado Frito', 'Pargo rojo frito con arepa y limon', 1, 10.00, 15, 1, NULL, 0.99),
(2, 'sin', 'Refrescos', 'cool 2 litros', 2, 1.50, 1, 1, NULL, 0.46),
(3, '121', 'Tomate', 'a', 1, 40.00, 1, 1, NULL, 24.00);
...
(8, '21312321312312', 'pargo', 'aaaaaaaaaaaaaaa', 1, 1, 22.00, 24.00, 6, 5, 'Kilogramo', 1, '2025-05-07 21:07:22');
...
--
DELIMITER $$
CREATE TRIGGER `after_receta_change` AFTER INSERT ON `recetas` FOR EACH ROW BEGIN
    DECLARE total_costo DECIMAL(10,2);
    
    -- Calcular el nuevo costo total del platillo
    SELECT SUM((i.Precio / i.Cantidad) * r.Cantidad) INTO total_costo
    FROM Recetas r
    JOIN Ingredientes i ON r.IngredienteID = i.IngredienteID
    WHERE r.PlatilloID = NEW.PlatilloID;
    
    -- Actualizar el costo en la tabla Platillos
    UPDATE Platillos 
    SET CostoFabricacion = IFNULL(total_costo, 0)
    WHERE PlatilloID = NEW.PlatilloID;
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `after_receta_delete` AFTER DELETE ON `recetas` FOR EACH ROW BEGIN
    DECLARE total_costo DECIMAL(10,2);
    ...
    FROM Recetas r
    JOIN Ingredientes i ON r.IngredienteID = i.IngredienteID
    WHERE r.PlatilloID = OLD.PlatilloID;
    
    -- Actualizar el costo en la tabla Platillos
    UPDATE Platillos 
    SET CostoFabricacion = IFNULL(total_costo, 0)
    WHERE PlatilloID = OLD.PlatilloID;
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `after_receta_update` AFTER UPDATE ON `recetas` FOR EACH ROW BEGIN
    DECLARE total_costo DECIMAL(10,2);
...
(11, 26, '2025-05-27 18:19:24', 1, 55);
...
(26, 1, 1, '2025-05-29', '2025-05-30', 2, 0, 'Completada', NULL, '', '2025-05-09 11:31:16'),
...
(29, 1, 1, '2025-06-04', '2025-06-05', 1, 0, 'Completada', 25.00, NULL, '2025-05-27 20:08:50');
...
INSERT INTO `servicios` (`ServicioID`, `Nombre`, `Descripcion`, `Precio`, `Tipo`, `costom`, `Activo`) VALUES
(3, 'Alquiler de Tordo', 'Alquiler de tordo', 10.00, 'General', '5', 1),
(4, 'Jesus Alfreo', 'oooooo', 25.00, 'General', '5', 1);
...
(47, 1, 1, '2025-05-12 19:04:50', '', 20.00, 0.00, 2.40, 22.40, 'Efectivo', 'Cancelada', NULL),
(48, 1, 1, '2025-05-12 19:05:47', '', 20.00, 0.00, 2.40, 22.40, 'Efectivo', 'Cancelada', NULL),
(49, 1, 1, '2025-05-12 19:50:17', '', 30.00, 0.00, 3.60, 33.60, 'Efectivo', 'Cancelada', NULL),
...
(52, 1, 1, '2025-05-27 10:48:26', 'Producto', 24.00, 0.00, 3.84, 27.84, 'Efectivo', 'Completada', ''),
(53, 1, 1, '2025-05-27 11:12:27', 'Producto', 10.00, 0.00, 1.60, 11.60, 'Efectivo', 'Completada', ''),
(54, 1, 1, '2025-05-27 11:36:46', 'Producto', 10.00, 0.00, 1.60, 11.60, 'Tarjeta', 'Completada', ''),
(55, 1, 1, '2025-05-27 18:19:24', 'Habitacion', 25.00, 0.00, 4.00, 29.00, 'Efectivo', 'Completada', NULL),
(56, 1, 1, '2025-05-27 17:49:36', 'Restaurante', 11.20, 0.00, 1.34, 12.54, 'Efectivo', 'Completada', NULL),
(58, 1, 1, '2025-05-27 20:08:50', 'Paquete', 50.00, 0.00, 0.00, 50.00, 'Efectivo', 'Completada', NULL);
...
(5, 47, '2025-05-27 10:24:29', 1, 'Anulación manual'),
(6, 49, '2025-05-27 10:24:40', 1, 'Anulación manual'),
(7, 48, '2025-05-27 10:24:51', 1, 'Anulación manual');
...
(73, 53, 'Servicio', 3, NULL, NULL, 1, 10.00, 0.00, 10.00),
(74, 54, 'Servicio', 3, NULL, NULL, 1, 10.00, 0.00, 10.00),
(75, 55, 'Habitacion', 1, '2025-05-29 00:00:00', '2025-05-30 00:00:00', 1, 25.00, 0.00, 25.00),
(78, 58, 'Paquete', 3, '2025-06-04 00:00:00', '2025-06-05 00:00:00', 1, 50.00, 0.00, 50.00),
(79, 58, 'Servicio', 3, '2025-06-04 00:00:00', '2025-06-05 00:00:00', 1, 10.00, 0.00, 10.00),
(80, 58, 'Habitacion', 1, '2025-06-04 00:00:00', '2025-06-05 00:00:00', 1, 25.00, 0.00, 25.00),
(81, 58, 'Servicio', 3, '2025-06-04 00:00:00', '2025-06-05 00:00:00', 1, 10.00, 0.00, 10.00);
...
--
ALTER TABLE `categoriasplatillos`
  MODIFY `CategoriaPlatilloID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `consumoingredientes`
  MODIFY `ConsumoID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
...
--
ALTER TABLE `ingredientes`
  MODIFY `IngredienteID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `ingredientesmovimientos`
--
ALTER TABLE `ingredientesmovimientos`
  MODIFY `idmovimientoi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;

--
-- AUTO_INCREMENT de la tabla `inventariomovimientos`
--
ALTER TABLE `inventariomovimientos`
  MODIFY `MovimientoID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `ordendetalles`
  MODIFY `DetalleID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT de la tabla `ordenesrestaurante`
--
ALTER TABLE `ordenesrestaurante`
  MODIFY `OrdenID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT de la tabla `paquetecomponentes`
--
ALTER TABLE `paquetecomponentes`
  MODIFY `ComponenteID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `platillos`
  MODIFY `PlatilloID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `recetas`
  MODIFY `RecetaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `reservaciones`
  MODIFY `ReservacionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `ventas`
  MODIFY `VentaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `ventaservicios`
  MODIFY `VentaServicioID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;

--
-- AUTO_INCREMENT de la tabla `ventasrestaurante`
--
ALTER TABLE `ventasrestaurante`
  MODIFY `VentaRestauranteID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
