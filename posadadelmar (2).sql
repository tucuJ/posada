...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2025 a las 01:44:43
...
(3, '121', 'Tomate', 'a', 1, 0.30, 1, 1, NULL, 0.00);
...
(3, 'Alquiler de Tordo', 'Alquiler de tordo', 10.00, 'General', '', 1);
...
--
ALTER TABLE `paquetecomponentes`
  MODIFY `ComponenteID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `recetas`
  MODIFY `RecetaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `ventas`
  MODIFY `VentaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `ventaservicios`
  MODIFY `VentaServicioID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
