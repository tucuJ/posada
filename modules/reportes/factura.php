            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <div class="border p-3">
                        ...
                        <p class="mb-1"><strong>Email:</strong> <?= $venta['Email'] ?? 'N/A' ?></p>
                        <p class="mb-0"><strong>NumeroDocumento:</strong> <?= $venta['NumeroDocumento'] ?? 'XAXX010101000' ?></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="border p-3">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="border p-3">
                        ...
                        <p class="mb-1"><strong>Moneda:</strong> Dolar Estadounidense</p>
